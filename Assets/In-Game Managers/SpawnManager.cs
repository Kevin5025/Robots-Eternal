...
public class SpawnManager : MonoBehaviour {
	...
	void Start () {
		blueRespawnPointGameObjectList.Add((GameObject)Instantiate(spawnPointGameObjectStock, new Vector2(-7.5f, -7.5f), Quaternion.identity));
		blueRespawnPointGameObjectList[0].GetComponent<SpawnPoint>().team = Actuator.Team.BLUE;

		redRespawnPointGameObjectList.Add((GameObject)Instantiate(spawnPointGameObjectStock, new Vector2(7.5f, 7.5f), Quaternion.Euler(0, 0, 180)));
