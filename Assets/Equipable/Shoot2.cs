 ...
 * Three pistols
 */
public class Shoot2 : ActivatableEquipable {

    public Shoot2 () : base(EquipableClass.Ability, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0.3f) {
    ...
    public override void Actuate (CircleAgent casterAgent) {
        ...
        //0.75sin(pi/3)//0.75cos(pi/3)
        Vector2 headPosition0 = casterAgent.transform.TransformPoint(new Vector2(-0.6495f * casterAgent.radius, 0.375f * casterAgent.radius));
        ...
        Vector2 headPosition1 = casterAgent.transform.TransformPoint(new Vector2(0f, 0.75f * casterAgent.radius));
        ...
        Vector2 headPosition2 = casterAgent.transform.TransformPoint(new Vector2(0.6495f * casterAgent.radius, 0.375f * casterAgent.radius));
        GameObject projectileGameObject2 = GameObject.Instantiate(PrefabReferences.prefabReferences.circleSmall2, headPosition2, casterAgent.transform.rotation);
        projectileGameObject2.GetComponent<Rigidbody2D>().velocity = forwardDirection * 10f;
        Projectile projectile2 = projectileGameObject2.AddComponent<Projectile>();
        projectile2.team = casterAgent.team;
        projectile2.casterAgent = casterAgent;
        projectile2.mechanicalDamage = casterAgent.mechanicalWeapon;
